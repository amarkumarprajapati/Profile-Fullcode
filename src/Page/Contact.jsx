...
const Contact = () => {
  ...
  const sendMessage = () => {
    ...
    const whatsappLink = `https://wa.me/${8908013842}?text=${encodeURIComponent(message)}`;
    ...
    <div>
       <div className='contectsec'>
        <div className='seconddiv'>
         ...
         <motion.h1
         className='h1lets'>
         Let’s find solutions<br/> <span className='spantagcont'>together?</span></motion.h1>
...
<div className='firstdiv'>
      ...
      <form className='formclass'>
        ...
        <input type='text' name='Help' className='input' onChange={handleChange} />
      </form>
      <form className='formclass'>
        <h1 className='input12'>Location</h1>
        <input type='text' name='Timeframe' className='input' onChange={handleChange} />
      </form>
      <form className='formclass'>
        <h1 className='input12'>What would make you happy in this project?</h1>
        <input type='text' name='Happiness' className='input' onChange={handleChange} />
        <img
